...
st.markdown("<p><h3><span style='color: blue;'>3. Name Entity Recogition</h3></span></p>", unsafe_allow_html=True)
...
st.markdown("<p><h3><span style='color: blue;'>4. Supervised and Unsupervised ML</h3></span></p>", unsafe_allow_html=True)
